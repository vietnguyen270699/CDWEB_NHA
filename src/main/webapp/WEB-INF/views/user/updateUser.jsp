					...
					<div class="agent-profile">
						<div class="row">
                            <form id="contact-form" name="form1" method="post" action="#">
								...
								<div class="form-group">
                                    <div class="row">
										<div class="col-sm-6">
											...
											<input type="email" name="customer_mail" id="customer_mail" class="form-control" disabled>
										</div>
                                    </div>
									<div class="row">
										<div class="col-sm-6">
											<label for="subject">Mật khẩu cũ*</label>
											<input type="password" name="subject" id="subject" class="form-control" data-msg-required="Please enter the subject." required>
										</div>
                                    </div>
                                    <div class="row">
										<div class="col-sm-6">
											<label for="subject">Mật khẩu mới*</label>
											<input type="password" name="subject" id="subject" class="form-control" data-msg-required="Please enter the subject." required>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6">
											...
											<input type="number" name="subject" id="subject" class="form-control" data-msg-required="Please enter the subject." value="0963052585" required>
										</div>
									</div>
								...
								<div class="form-group">
                                    <input type="submit" value="Cập nhật" class="btn btn-primary min-wide" >
